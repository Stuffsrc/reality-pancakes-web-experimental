            ...
            font = pygame.font.Font("assets/fonts/schrift.ttf", 24)
                ...
                def placewhereyouprobablydie():
                    ...
                    if choice == "y":
                        ...
                        time.sleep()
                ...
                def placewhereyoumightdie():
                    ...
                    if choice == "y":
                        game_state["2nd_run"] = True
                        print("alright, hold up...")
                        time.sleep()
                        print("welcome back! pls choose ur difficulty.")
                        time.sleep(2)
                        titlescreen()
                    elif choice == "n":
                ...
                def surviveending():
                    ...
                    if choice == "y":
                        ...
                        sys.exit()
                def story():
                    print(f"alright, {game_state['name']}. i will now tell a story about the world i used to reside in.")
